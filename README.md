...
Здравствуйте, это Усман.
Не знаю поможет ли вам это информация, но все же напишу. Я никогда не пользовался DRF и API, так что для меня это ТЗ было сложным( я сделал максимум что мог.
Примерно 3-4 дня я делал это задания с утра по ночи и это все доработки которые я смог добавить.
20-22  числа меня позвали на какое созтязание по школе так что дальше не смогу дальше разрабатывать это ТЗ, но если там появится свободное время попытаюсь еще хоть что то добавить.
